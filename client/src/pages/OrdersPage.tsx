...
const columns = [
  ...
  { key: "date_valet_agency", label: "Оплачена валюта поставщику/субагенту", sortable: true },
  { key: "date_taking_agency", label: "Получена валюта поставщиком/субагентом", sortable: true },
  { key: "date_paid_rub", label: "Оплачен рубль клиенту", sortable: true },
  ...
  { key: "serial_num_for_payer", label: "Порядковый номер заявления для плательщика", sortable: true },
  { key: "date_docs_agent_and_subagent", label: "Дата подготовки документов", sortable: true },
  ...
  { key: "comment_problem", label: "Комментарии к проблемным заявкам", sortable: false },
