const columns = [
  ...
  { key: "managers", label: "Менеджеры", sortable: false, type: "managers" },
  ...
  { key: "contractors", label: "Контрагент", sortable: false, type: "contractors" },
  { key: "agents", label: "Агенты", sortable: false, type: "agents" },
  { key: "clients", label: "Клиенты", sortable: false, type: "clients" },
  { key: "client_inn", label: "ИНН клиента", sortable: true, type: "text" },
  ...
  { key: "countries", label: "Страна", sortable: true, type: "countries" },
  { key: "calc_condition", label: "Условия расчета", sortable: true, type: "text" },
  { key: "type_transaction", label: "Вид сделки", sortable: true, type: "text" },
  ...
  { key: "currency", label: "Валюта", sortable: true, type: "number" },
  ...
  { key: "subagents", label: "Субагент", sortable: false, type: "subagents" },
  { key: "subagentPayers", label: "Плательщик субагента", sortable: false, type: "subagentPayers" },
  ...
  { key: "status_swift", label: "Статус SWIFT", sortable: true, type: "option" },
  { key: "stuck_money", label: "Зависли деньги", sortable: true, type: "boolean" },
  { key: "stage_problem", label: "Стадии проблемы", sortable: true, type: "text" },
  { key: "comment_problem", label: "Комментарии к заявкам по которым зависли деньги", sortable: false, type: "text" },
  { key: "stuck_money_name", label: "Какая валюта зависла?", sortable: true, type: "text" },
  { key: "stuck_money_sum", label: "Сумма зависла", sortable: true, type: "boolean" },
  { key: "mistake_is_it_name", label: "Чья ошибка?", sortable: true, type: "text" },
