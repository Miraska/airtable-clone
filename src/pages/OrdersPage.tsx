...
const columns = [
  ...
  {key: "managers", label: "Менеджер", sortable: true},
  {key: "reviewers", label: "Проверяющий", sortable: true},
  {key: "date", label: "Дата размещения", sortable: true},
  {key: "date_hired", label: "Взята в работу", sortable: true},
  {key: "contractors", label: "Контрагент", sortable: true},
  {key: "agents", label: "Агент", sortable: true},
  {key: "clients", label: "Клиент", sortable: true}, 
  {key: "client_inn", label: "ИНН (from Клиент)", sortable: true},
  ...
  {key: "country_id", label: "Страна", sortable: true},
  ...
  {key: "subagents", label: "Субагент", sortable: true},
  {key: "subagentPayers", label: "Плательщик Субагента", sortable: true},
  {
  ...
  {key: "order_link", label: "Заявка", sortable: true},
  {key: "invoice_link", label: "Инвойс", sortable: true},
  {key: "assignment_link", label: "Поручение", sortable: true},
  {key: "swift_link", label: "SWIFT", sortable: true},
  {key: "swift103_link", label: "SWIFT 103", sortable: true},
  {key: "swift199_link", label: "SWIFT 199", sortable: true},
  {key: "act_link", label: "Акт-отчет", sortable: true},
